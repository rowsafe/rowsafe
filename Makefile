...
.PHONY: all build test lint check-installer test-installer test-mongodb test-rewind test-secondcopy test-mysql test-upgrade test-action dist release check-release-env clean
